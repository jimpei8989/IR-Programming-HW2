...
def main():
    ...
    with EventTimer('Load data'):
        ...
        validDataset = BPRDataset(mat, args.datadir, 'valid', args.epochSize)
    ...
    with EventTimer('Train Model'):
        ...
        for epoch in range(1, args.epochs + 1):
            with EventTimer(verbose=False) as et:
                ...
                print(f'> Epoch {epoch} / {args.epochs}: [{et.gettime():.4f}s] Train Loss: {trainLoss:.6f} | Valid Loss: {validLoss:.6f}')
